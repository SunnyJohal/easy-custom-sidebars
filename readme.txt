...
== Changelog ==
= 2.0.0 - Complete Plugin Rewrite =

- Important: You need to have php 7.2+ installed on your server to use this plugin.
- Rewrote the plugin from the ground up.
- The admin screen is built using React and utilises the REST API.
- Created public github repo to manage development going forward.
- Improved query performance on the frontend.
